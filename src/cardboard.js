  ...
  .value('DefaultSettings', {
    ...
    backgrounds: [
      {
        ...
        type: 'Default',
        url: {
          dawn: '/resources/google_logo.svg',
          day: '/resources/google_logo.svg',
          dusk: '/resources/google_logo.svg',
          night: '/resources/google_logo.svg',
        },
      },
      {
        id: 1,
    ...
    cards: [
      ...
      },
      {
        ...
        system: true,
        enabled: false,
        template: 'src/templates/cards/ChangelogCard.html',
      },
    ],
